...
import { removeCartProduct } from "../src/ProductSlice";
...
const Cart = () => {
  ...
  const cartProductsData = cartProducts.map((e) => {
    const productData = screenProducts.find((pdata) => pdata.id == e[0]);
    return {
      quantity: e[1],
              ...
              >
                ...
                <div className="flex flex-col justify-between w-full">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-red-500 text-sm hover:underline" onClick={(_) => handleRemove(productData.id)}>
                      Remove
                    </button>
                  </div>
                </div>
